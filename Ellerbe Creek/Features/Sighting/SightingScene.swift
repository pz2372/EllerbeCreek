...
class SightingScene: SKScene {
    ...
    public weak var sightingViewDelegate: SightingViewDelegate?
    ...
    private func setUpWorld() {
        guard let currentFrame = sceneView.session.currentFrame,
              let scene = SKScene(fileNamed: "SightingScene") else { return }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        self.sightingViewDelegate?.sightingCompleted(true)
